...
class Account(AbstractBaseUser):
    ...
    #required(mandatory when we create custom user model)
    ...
    #required methods when creating custom user model
    
    #if the user is admin,he has all the permissions to do all the changes
